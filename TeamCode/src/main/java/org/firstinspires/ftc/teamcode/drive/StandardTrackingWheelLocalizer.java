...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double GEAR_RATIO = 1; // output (wheel) sped / input (encoder) speed

    public static double LATERAL_DISTANCE = 9.76; // in; distance between the left and right wheels
